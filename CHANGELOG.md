...
## [0.11.6](https://github.com/heroku/heroku-connect-plugin/compare/heroku-connect-plugin-v0.11.5...heroku-connect-plugin-v0.11.6) (2026-02-06)
...
* fix linting for workflows and standard ([#257](https://github.com/heroku/heroku-connect-plugin/issues/257)) ([32983cd](https://github.com/heroku/heroku-connect-plugin/commit/32983cde71cc936b5dfe642efcb50788a58a85d3))


### Miscellaneous Chores

* add github actions ci ([7bd5e7d](https://github.com/heroku/heroku-connect-plugin/commit/7bd5e7d6d09643f57ede27b280af4c6ef373d00c))
* add github actions ci ([e32d222](https://github.com/heroku/heroku-connect-plugin/commit/e32d222bd9832614c9f1fc09d4a44265b3bf59ef))
* bump actions/checkout from 4 to 6 ([#242](https://github.com/heroku/heroku-connect-plugin/issues/242)) ([325a564](https://github.com/heroku/heroku-connect-plugin/commit/325a5647c521f828a8c891ce47eba06287874092))
* onboard shared workflows ([#240](https://github.com/heroku/heroku-connect-plugin/issues/240)) ([ceb36e0](https://github.com/heroku/heroku-connect-plugin/commit/ceb36e0954dfb168e80b5c77798ec362a20456fb))
* onboard shared workflows ([#250](https://github.com/heroku/heroku-connect-plugin/issues/250)) ([4d31d1f](https://github.com/heroku/heroku-connect-plugin/commit/4d31d1fb03a95d80efcf312a76fc338e80502825))
* update glob resolution in yarn.lock ([#235](https://github.com/heroku/heroku-connect-plugin/issues/235)) ([dcfb96c](https://github.com/heroku/heroku-connect-plugin/commit/dcfb96ccb6e7f97036a872d6eb56fde56a5da0a3))
