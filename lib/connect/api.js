...
export const withUserConnections = co.wrap(function * (context, appName, flags, allowNone, heroku, addonType) {
  const connectClient = new ConnectClient(context)
...
export function withConnection (context, heroku, addonType) {
  return co(function * () {
    const connectClient = new ConnectClient(context)
    const discoveryClient = new DiscoveryClient(context)
...
export function withMapping (connection, objectName) {
  return co(function * () {
...
export function withStream (context, connection, objectName) {
  return co(function * () {
...
export function getStreams (context, connection) {
  return co(function * () {
    const connectClient = new ConnectClient(context)
...
export function withStreams (context, connections) {
  return co(function * () {
...
export function requestAppAccess (context, app, flags, allowNone, heroku, addonType) {
  return co(function * () {
    const discoveryClient = new DiscoveryClient(context)
...
export const getWriteErrors = co.wrap(function * (context, heroku) {
  let url, action
